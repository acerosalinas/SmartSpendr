...
export function IconGear(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" {...props}>
      ...
      <path
        d="M12 3.5v2m0 13v2m8.5-8.5h-2m-13 0h-2m14.6-6.1-1.4 1.4M6.3 17.7l-1.4 1.4m13.8 0-1.4-1.4M6.3 6.3 4.9 4.9"
        strokeLinecap="round"
      />
    </svg>
  );
...
export function IconPieChart(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" {...props}>
      <path d="M12 3.5v8.5h8.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M20.5 13.5A8.5 8.5 0 1 1 11 3.55" strokeLinecap="round" />
    </svg>
  );
}

export function IconCalendarClock(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" {...props}>
      <rect x="3" y="4.5" width="18" height="16" rx="2" />
      <path d="M3 9.5h18M8 3v3M16 3v3" strokeLinecap="round" />
      <circle cx="12" cy="15" r="3.2" />
      <path d="M12 13.5V15l1 .8" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
